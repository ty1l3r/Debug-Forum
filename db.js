...
const userSchema = new mongoose.Schema({
    ...
    paperModel = mongoose.model('papers', paperSchema); //EO mep modèles
...
connect2Db = function(callBack) {
    mongoose.connect('mongodb://localhost/forumDebug1', { useNewUrlParser: true }, function(err, db) {

        //------ Code DEBUG ----//

        // if (username = 0) {
        //     resizeBy.render('signin.js', { session: requestAnimationFrame.session })
